...
#include "$CurrentDir:\\mpmissions\\ExpansionDEBUG.ChernarusPlus\\expansion\\ExpansionObjectSpawnTools.c"
#include "$CurrentDir:\\mpmissions\\ExpansionDEBUG.ChernarusPlus\\expansion\\missions\\MissionConstructor.c"
