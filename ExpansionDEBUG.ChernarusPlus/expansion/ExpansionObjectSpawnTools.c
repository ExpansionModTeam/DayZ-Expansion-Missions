...
void FindMissionFiles(string worldname, bool loadObjects, bool loadTraders)
{
	...
	string objectFilesFolder = "$CurrentDir:\\mpmissions\\ExpansionDEBUG." + worldname + "\\expansion\\objects\\";
	string traderFilesFolder = "$CurrentDir:\\mpmissions\\ExpansionDEBUG." + worldname + "\\expansion\\traders\\";
...
void LoadMissionObjectsFile( string name, string worldname )
{
	...
	string filePath = "$CurrentDir:\\mpmissions\\ExpansionDEBUG." + worldname +"\\expansion\\objects\\" + name;
...
void LoadMissionTradersFile( string name, string worldname )
{
	...
	string filePath = "$CurrentDir:\\mpmissions\\ExpansionDEBUG." + worldname + "\\expansion\\traders\\" + name;
	FileHandle file = OpenFile( filePath, FileMode.READ );
