class COMEditorMenu extends UIScriptedMenu 
{
	...
	{
		layoutRoot 				= GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\ExpansionCOM.TakistanPlus\\core\\modules\\ComEditor\\gui\\layouts\\EditorMenu.layout" );
		...
		m_aiMenu   				= GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\ExpansionCOM.TakistanPlus\\core\\modules\\ComEditor\\gui\\layouts\\AIMenu.layout", layoutRoot );
		m_objectMenu   			= GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\ExpansionCOM.TakistanPlus\\core\\modules\\ComEditor\\gui\\layouts\\ObjectMenu.layout", layoutRoot );
		m_weatherMenu  			= GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\ExpansionCOM.TakistanPlus\\core\\modules\\ComEditor\\gui\\layouts\\WeatherMenu.layout", layoutRoot );
		m_positionMenu 			= GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\ExpansionCOM.TakistanPlus\\core\\modules\\ComEditor\\gui\\layouts\\PositionMenu.layout", layoutRoot );
		m_gameMenu 	   			= GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\ExpansionCOM.TakistanPlus\\core\\modules\\ComEditor\\gui\\layouts\\GameMenu.layout", layoutRoot );
		m_matMenu 	   			= GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\ExpansionCOM.TakistanPlus\\core\\modules\\ComEditor\\gui\\layouts\\CameraMenu.layout", layoutRoot );
		m_objectInfoMenu 		= GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\ExpansionCOM.TakistanPlus\\core\\modules\\ComEditor\\gui\\layouts\\ObjectEditorInfo.layout", layoutRoot );
