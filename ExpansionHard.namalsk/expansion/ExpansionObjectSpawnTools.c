...
void FindMissionFiles(string worldname, bool loadObjects, bool loadTraders)
{
	...
	string objectFilesFolder = "$CurrentDir:\\mpmissions\\ExpansionHard." + worldname + "\\expansion\\objects\\";
	string traderFilesFolder = "$CurrentDir:\\mpmissions\\ExpansionHard." + worldname + "\\expansion\\traders\\";
...
void LoadMissionObjectsFile( string name, string worldname )
{
	...
	string filePath = "$CurrentDir:\\mpmissions\\ExpansionHard." + worldname +"\\expansion\\objects\\" + name;
...
void LoadMissionTradersFile( string name, string worldname )
{
	...
	string filePath = "$CurrentDir:\\mpmissions\\ExpansionHard." + worldname + "\\expansion\\traders\\" + name;
	FileHandle file = OpenFile( filePath, FileMode.READ );
